...
public class AngularParser extends Parser {
	...
	public static final int
		...
		ATTRIBUTE=133, WHITESPACE=134, COMMENT=135, END_HTML=136, STYLE_TEMPLATE=137;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'log'", "'catch'", "'error'", "'export'", "'interface'", "'class'", 
			"'enum'", "'extends'", "'implements'", "'constructor'", "'this'", "'new'", 
			"'function'", "'private'", "'public'", "'protected'", null, "'>='", null, 
			"'<='", null, "'!'", "'=='", "'!='", "'==='", "'!=='", "'+'", "'-'", 
			"'*'", null, "'%'", "'&&'", "'||'", "'&'", "'^'", null, "'+='", "'-='", 
			"'*='", "'/='", "'%='", "'**='", "'>>='", "'<<='", "'>>>='", "'&='", 
			"'^='", "'|='", "'=>'", "'??'", "'++'", "'--'", "';'", null, "','", "'.'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DDIRECTIVE", "P", "REFERENCE_VAR", "ATTRIBUTE", "WHITESPACE", "COMMENT", 
			"END_HTML", "STYLE_TEMPLATE"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 148556729653658592L) != 0) || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2251800342647971L) != 0)) {
				{
				setState(180);
				_errHandler.sync(this);
	...
	public final NormalFunctionContext normalFunction() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 148548418959048704L) != 0) || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2251800342189219L) != 0)) {
				{
				setState(267);
				parameterList();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 148548483316449280L) != 0) || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2251800342647971L) != 0)) {
				{
				setState(313);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ConstructorBodyContext constructorBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 148548481705836544L) != 0) || ((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 2251800342647971L) != 0)) {
				{
				{
				setState(614);
				statement();
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode STYLE_TEMPLATE() { return getToken(AngularParser.STYLE_TEMPLATE, 0); }
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(926);
			_la = _input.LA(1);
			if ( !(((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 268435487L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
